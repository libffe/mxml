                 ...
                 const char *data)  /* I - New data string */
{
  ...
  if (node->value.element.name) free(node->value.element.name);
        ...
        mxml_custom_destroy_cb_t destroy) /* I - New destructor function */
{
  ...
  if (!node || node->type != MXML_CUSTOM) return (-1);
                   ...
                   const char *name)  /* I - New name string */
{
  ...
  if (!node || node->type != MXML_ELEMENT || !name) return (-1);
                   ...
                   int integer)       /* I - Integer value */
{
  ...
  if (!node || node->type != MXML_INTEGER) return (-1);
                  ...
                  const char *opaque) /* I - Opaque string */
{
  ...
  if (!node || node->type != MXML_OPAQUE || !opaque) return (-1);

  /*
   * Free any old opaque value and set the new value...
   */

  if (node->value.opaque) free(node->value.opaque);
                ...
                double real)       /* I - Real number value */
{
  ...
  if (!node || node->type != MXML_REAL) return (-1);
        ...
        const char *string) /* I - String */
{
  ...
  if (!node || node->type != MXML_TEXT || !string) return (-1);

  /*
   * Free any old string value and set the new value...
   */

  if (node->value.text.string) free(node->value.text.string);
        ...
        ...)                /* I - Additional arguments as needed */
{
  ...
  if (!node || node->type != MXML_TEXT || !format) return (-1);
