    ...
    mxml_node_t *node)  /* I - Node to add */
{
  ...
  if (node->parent) mxmlRemove(node);
                ...
                double real)         /* I - Real number value */
{
  ...
  if ((node = mxml_new(parent, MXML_REAL)) != NULL) node->value.real = real;
             ...
             mxml_type_t type)    /* I - Node type */
{
  ...
  if (parent) mxmlAdd(parent, MXML_ADD_AFTER, MXML_ADD_TO_PARENT, node);
